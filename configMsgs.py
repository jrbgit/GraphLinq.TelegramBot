...
websites = [
    ...
    ['GraphLinq.App', 'Desc', 'https://glq.link/app'],
    ['GraphLinq.Chain.Explorer','', 'https://glq.link/explorer'],
    ['GraphLinq.Chain.Status', 'Desc.', 'https://glq.link/network'],
    ['GraphLinq.Documentation','Desc', 'https://glq.link/docs'], # https://glq.link/documentation https://glq.link/doc
    ['GraphLinq.IDE', 'Desc', 'https://glq.link/ide'],
    ['GraphLinq.MarketPlace', 'Desc', 'https://glq.link/marketplace']
]
